...
#   CP (control-plane context), NS. Set STEP=1 to advance on Enter instead of
#   auto-pausing (handy for a dry run).
set -uo pipefail
...
run "kubectl --context \$CP -n $NS get modelreplica -o wide"
