...
---
**API:** [`infrastructure.modelplane.ai/v1alpha1` · ServingStack]({{< ref "reference#crd-servingstack" >}})
<!-- vale write-good.Passive = NO -->
A `ServingStack` installs the serving substrate on a Kubernetes cluster. Includes
...
{{< manifests "platform/serving-stack.yaml" >}}
