...
builders, Kubernetes object wrappers, condition management, secret handling, GPU
VRAM lookups, and serving profile matching. If you find yourself duplicating
logic across functions, it probably belongs in `lib/`.
