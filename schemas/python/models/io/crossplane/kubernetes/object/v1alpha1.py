...
class Readiness(BaseModel):
    policy: Literal['SuccessfulCreate', 'DeriveFromObject', 'AllTrue'] | None = (
        'SuccessfulCreate'
    )
    """
...
class Spec(BaseModel):
    ...
    """
    managementPolicy: (
        Literal['Default', 'ObserveCreateUpdate', 'ObserveDelete', 'Observe'] | None
    ) = 'Default'
    """
    ...
    configured.
    """
    providerRef: ProviderRef | None = None
    """
