...
#   filename:  workdir/vultr_m_crossplane_io_v1alpha1_iso.yaml
...
class ForProvider(BaseModel):
    description: str
    """
    The user-supplied description of the ISO.
    """
    url: str
    """
...
class Spec(BaseModel):
    ...
    """
    ForProvider holds the user-supplied parameters for this Iso.
    """
    managementPolicies: (
...
class IsoList(BaseModel):
    ...
    items: list[Iso]
    """
    List of isoes. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: str | None = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
