...
#   filename:  workdir/vultr_m_crossplane_io_v1alpha1_firewallgroup.yaml
...
class Spec(BaseModel):
    ...
    """
    ForProvider holds the user-supplied parameters for this FirewallGroup.
    """
    managementPolicies: (
