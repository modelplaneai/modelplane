...
#   filename:  workdir/efs_aws_upbound_io_v1beta1_accesspoint.yaml
...
class PosixUserItem(BaseModel):
    gid: float | None = None
    """
    POSIX group ID used for all file system operations using this access point.
    """
    secondaryGids: list[float] | None = None
    """
...
class CreationInfoItem(BaseModel):
    ownerGid: float | None = None
    """
    POSIX group ID to apply to the root_directory.
    """
    ownerUid: float | None = None
    """
...
class RootDirectoryItem(BaseModel):
    creationInfo: list[CreationInfoItem] | None = None
    """
...
class ForProvider(BaseModel):
    ...
    """
    posixUser: list[PosixUserItem] | None = None
    """
    ...
    """
    rootDirectory: list[RootDirectoryItem] | None = None
    """
...
class AccessPoint(BaseModel):
    ...
    """
    kind: Literal['AccessPoint'] | None = 'AccessPoint'
    """
...
class AccessPointList(BaseModel):
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: list[AccessPoint]
    """
    List of accesspoints. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: str | None = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
