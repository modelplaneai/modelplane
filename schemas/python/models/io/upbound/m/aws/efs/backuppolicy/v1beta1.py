...
#   filename:  workdir/efs_aws_m_upbound_io_v1beta1_backuppolicy.yaml
...
class ForProvider(BaseModel):
    backupPolicy: BackupPolicy | None = None
    """
...
class BackupPolicyModel(BaseModel):
    ...
    """
    kind: Literal['BackupPolicy'] | None = 'BackupPolicy'
    """
