...
class Endpoint(BaseModel):
    ...
    """
    Lower is preferred. Entries at the same priority share traffic by weight; a higher-numbered entry is only tried when no lower-numbered one has a healthy endpoint.
    """
    selector: Selector
    """
