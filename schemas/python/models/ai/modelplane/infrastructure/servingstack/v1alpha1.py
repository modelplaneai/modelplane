...
class Gateway(BaseModel):
    ...
    Presenting one of these is how a caller proves it is an InferenceGateway. Requests without one are refused, which is what makes an InferenceGateway the only thing that can reach the engines behind this cluster's gateway.
    """
