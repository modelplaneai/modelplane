...
""",
            ...
            "devicePlugin": {
                "enabled": False,
                "env": [
                    {"name": "DP_DISABLE_HEALTHCHECKS", "value": "109"},
            ...
            "toolkit": {
                ...
                "env": [
                    ...
                    {"name": "ACCEPT_NVIDIA_VISIBLE_DEVICES_AS_VOLUME_MOUNTS", "value": "true"},
                ],
            },
        ...
        manifests=[
            {
                ...
                "spec": {
                    "selector": {"matchLabels": {"app.kubernetes.io/name": "nvidia-toolkit-hardening"}},
...
""",
                                    ...
                                    "readinessProbe": {
                                        "exec": {"command": ["test", "-f", "/tmp/hardened"]},
